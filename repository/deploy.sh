...
DEPLOY_PATH=/Users/minglv/AndroidStudioProjects/spring/maven-repo/repository
CURRENT_PATH=`pwd`
...
deployFunc(){
  ...
  cd $CURRENT_PATH
  # 开始deploy
  mvn clean deploy -Dmaven.test.skip  -DaltDeploymentRepository=self-mvn-repo::default::file:/Users/minglv/AndroidStudioProjects/spring/maven-repo/repository
